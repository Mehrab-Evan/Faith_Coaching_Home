...
<body class="bodyclass">
    ...
    <div style="text-align: center;">
        ...
        <form action="{{route('class6.paymentConfirm',$students9->id)}}" method="post">
            @csrf
        ...
        <a href="{{route('class6.paymentHistory', $students9->id)}}"><button class="classbutton">Payment History</button></a>
