...
<body class="bodyclass">
    ...
    <p>{{Session::get('msg')}}</p>
    @endif
    <form action="{{route('class12.Update', $students9->id)}}" method="post">
        @csrf 
        <div class="table-class">
            <table border="1" width=1500>
                <tr style="height : 120px">
                    <td><label for="">Student's Name</label></td>
                    <td><input class="inptype" type="text" name="student_name" value="{{$students9->name}}" placeholder="Student's Name"></td>
                </tr>
                <tr style="height : 120px">
                    <td>
                    ...
                    <td>
                        <input class="inptype" type="text" name="father_name" value="{{$students9->fathers_name}}" placeholder="Father's Name">
                </tr>
                <tr style="height : 120px">
                    <td><label for="">Mother's Name</label></td>
                    <td><input class="inptype" type="text" name="mother_name" value="{{$students9->mothers_name}}" placeholder="Mother's Name"></td>
                </tr>
                <tr style="height : 120px">
                    <td><label for="">School</label></td>
                    <td><input class="inptype" type="text" name="school" value="{{$students9->school}}" placeholder="School"></td>
                </tr>
                <tr style="height : 120px">
                ...
                <tr style="height : 120px">
                    ...
                    <td>
                        <input class="inptype" type="date" name="dob" value="{{$students9->dob}}" placeholder="Date of Birth">
                    </td>
                </tr>
                <tr style="height : 120px">
                    <td>
    ...
    <div style="padding-bottom : 50px; padding-top : 50px;">
            <div style="padding-top : 20px">
                <a href="{{route('class12.class12Crud')}}"><button class="AddButton">Back</button></a>
            </div>
    </div>
</body>
</html1