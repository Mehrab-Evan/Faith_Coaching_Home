...
<body class="bodyclass">
    ...
    <div style="padding-top : 20px">
        <a href="{{route('class12.newStudent')}}"><button class="AddButton" >Add new Student</button></a>
    </div>
    <div class="table-class">
        <table border="1" width=1500>
            ...
            <tr style="height : 80px">
                ...
                <td>{{$student->year}}</td>
                <td>
                    <a href="{{route('class12.Edit', $student->id)}}"><button class="table-btn">Edit</button></a>
                    <a href="{{route('class12.Delete', $student->id)}}" onclick="return confirm('Are you sure to delete?')"><button class="table-btn">Delete</button></a>
                    <a href="{{route('class12.showindi', $student->id)}}"><button class="table-btn">Show</button></a>
                </td>
            </tr>
            @endforeach
        </table>
