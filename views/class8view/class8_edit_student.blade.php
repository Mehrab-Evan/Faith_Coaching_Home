...
<body class="bodyclass">
    ...
    <p>{{Session::get('msg')}}</p>
    @endif
    <form action="{{route('class8.Update', $students8->id)}}" method="post">
        @csrf 
        <div class="table-class">
            <table border="1" width=1500>
                <tr style="height : 120px">
                    <td><label for="">Student's Name</label></td>
                    <td><input class="inptype" type="text" name="student_name" value="{{$students8->name}}" placeholder="Student's Name"></td>
                </tr>
                <tr style="height : 120px">
                    <td>
                    ...
                    <td>
                        <input class="inptype" type="text" name="father_name" value="{{$students8->fathers_name}}" placeholder="Father's Name">
                </tr>
                <tr style="height : 120px">
                    <td><label for="">Mother's Name</label></td>
                    <td><input class="inptype" type="text" name="mother_name" value="{{$students8->mothers_name}}" placeholder="Mother's Name"></td>
                </tr>
                <tr style="height : 120px">
                    <td>
                    ...
                    <td>
                        <input class="inptype" type="text" name="mobile" value="{{$students8->mobile}}" placeholder="Mobile Number">
                    </td>
                </tr>
                <tr style="height : 120px">
                    <td>
                    ...
                    <td>
                        <input class="inptype" type="date" name="dob" value="{{$students8->dob}}" placeholder="Date of Birth">
                    </td>
                </tr>
                <tr style="height : 120px">
                    <td>
                    ...
                    <td>
                        <input class="inptype" type="text" name="year" value="{{$students8->year}}" placeholder="Year">
                    </td>
                </tr>
