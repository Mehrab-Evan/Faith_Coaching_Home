...
<body class="bodyclass">
    ...
    <div style="text-align: center;">
        <h1 id="StudentName" name="StudentName">{{$students9->name}}</h1>
        <form id="formid" action="{{route('class9.paymentConfirm',$students9->id)}}" method="post">
            @csrf
        ...
        <a href="{{route('class9.paymentHistory', $students9->id)}}"><button class="classbutton">Payment History</button></a>
    </div>
