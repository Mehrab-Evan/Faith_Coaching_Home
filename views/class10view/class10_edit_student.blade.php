...
<body class="bodyclass">
    ...
    <p>{{Session::get('msg')}}</p>
    @endif
    <form action="{{route('class10.Update', $students9->id)}}" method="post">
        @csrf 
    ...
    <div style="padding-bottom : 50px; padding-top : 50px;">
            <div style="padding-top : 20px">
                <a href="{{route('class10.class10Crud')}}"><button class="AddButton">Back</button></a>
            </div>
    </div>
</body>
</html>