...
<body class="bodyclass">
    ...
    <p>{{Session::get('msg')}}</p>
    @endif -->
    <form action="{{route('teacher.ifAdminLog')}}" method="post">
        @csrf 
        <div class="table-class">
            <table border="1" width=1500>
                ...
                <tr style="height : 120px">
                    ...
                    <td>
                        <input class="inptype" type="password" name="password" placeholder="Password">
                </tr>
                <tr style="height : 120px">
                    <td colspan=2>
                        <button type="submit" class="table-btn">Login</button>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div style="padding-bottom : 50px; padding-top : 50px;">
            <div style="padding-top : 20px">
                <a href="{{route('Pass.Edit')}}"><button class="AddButton" >Change Password</button></a>
            </div>
            <div style="padding-top : 20px">
