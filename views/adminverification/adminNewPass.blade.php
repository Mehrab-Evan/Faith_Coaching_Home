...
<body class="bodyclass">
    ...
    <p>{{Session::get('msg')}}</p>
    @endif -->
    <form action="{{route('teacher.EditAdmin')}}" method="post">
        @csrf 
        <div class="table-class">
            <table border="1" width=1500>
                <tr style="height : 120px">
                    <td><label for="">User Name</label></td>
                    <td><input class="inptype" type="text" name="username" placeholder="User"></td>
                </tr>
                <tr style="height : 120px">
                    <td>
                    ...
                    <td>
                        <input class="inptype" type="password" name="oldpassword" placeholder="Old Password">
                </tr>
                <tr style="height : 120px">
                    <td>
                    ...
                    <td>
                        <input class="inptype" type="password" name="newpassword" placeholder="New Password">
                    </td>
                </tr>
                <tr style="height : 120px">
                    <td>
                    ...
                    <td>
                        <input class="inptype" type="password" name="confirmpassword" placeholder="Confirm Password">
                    </td>
                </tr>
                <tr style="height : 120px">
                    <td colspan=2>
