...
<body class="bodyclass">
    ...
    <p>{{Session::get('msg')}}</p>
    @endif
    <form action="{{route('teacher.Store_data')}}" method="post">
        @csrf 
        <div class="table-class">
            <table border="1" width=1500>
                <tr style="height : 120px">
                    <td><label for="">Teacher's Name</label></td>
                    <td><input class="inptype" type="text" name="name" placeholder="Teacher's Name"></td>
                </tr>
                ...
                <tr style="height : 120px">
                    ...
                    <td>
                        <input class="inptype" type="text" name="courses" placeholder="Courses">
                </tr>
                <tr style="height : 120px">
                    <td><label for="">Classes</label></td>
                    <td><input class="inptype" type="text" name="classes" placeholder="Classes"></td>
                </tr>
                <tr style="height : 120px">
                    <td><label for="">Institution</label></td>
                    <td><input class="inptype" type="text" name="institution" placeholder="Institution"></td>
                </tr>
                <tr style="height : 120px">
                    <td><label for="">Department</label></td>
                    <td><input class="inptype" type="text" name="dept" placeholder="Department"></td>
                </tr>
                <tr style="height : 120px">
